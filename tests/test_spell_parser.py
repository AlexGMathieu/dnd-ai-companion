...
def test_all_links():
    ...
    base, document, liens = parser.parse(sort_test)

    assert "Objects come to life at your command." in document
    assert "monster:animated object (tiny):phb" in liens
    assert "If you cast this spell using a spell slot of 6th level or higher" in document
